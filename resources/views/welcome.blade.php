            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <img src="{{ url('/icons/castorLogo.png') }}" alt="" title="" width="150" height="75" />
                            <path
                    ...
                    @if (Route::has('login'))
                        <nav class="-mx-3 flex flex-1 justify-end">
                            ...
                            <button id="theme-toggle"
                                type="button"class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="https://github.com/alfonsolpzny/InnovaTube/" id="docs-card"
                                ...
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            Repositorio y documentación documentación del proyecto InnovaTube.
                                        </p>
                                    </div>
                                </div>
